      ...
      <div className="bg-[#e8e8e8] py-16">
        <div className="grid grid-cols-1 md:grid-cols-[50vw_25vw] grid-rows-[repeat(2,auto)] px-[clamp(10px,2%,80px)] justify-center gap-x-16 gap-y-4 ">
          ...
          <div className="flex flex-col gap-2 justify-self-center order-1 md:order-2 justify-center">
            ...
            <Button className=" bg-gradient-to-r from-orange-500 via-yellow-400 to-orange-500 text-black font-semibold hover:from-orange-500/90 hover:via-yellow-400/90 hover:to-orange-500  w-full h-12 text-lg hidden md:flex">
              Become a Pro Member
            </Button>
          </div>

          <div className="order-3">
            <Button className=" bg-gradient-to-r from-orange-500 via-yellow-400 to-orange-500 text-black font-semibold hover:from-orange-500/90 hover:via-yellow-400/90 hover:to-orange-500  w-full h-12 text-lg md:hidden flex">
              Become a Pro Member
            </Button>
          </div>
        </div>

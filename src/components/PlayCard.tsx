...
function PlayCard({ src, description , title}: PlayCardProps) {
  return (
    <div className="flex flex-col gap-4">
      <div
        className="aspect-video w-full bg-cover bg-no-repeat flex justify-center items-center"
        style={{
          backgroundImage: `url(${src})`,
          borderImage: 'linear-gradient(rgba(235, 219, 204, 0.5), rgba(20, 36, 51, 0.5)) fill 1'
        }}>
